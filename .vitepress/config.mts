...
const manualSidebar: SidebarItem[] = [
  {
    text: '入门',
    collapsed: false,
    items: [
  ...
  },
  {
    ...
    collapsed: false,
    items: [
      { text: '界面配置（箱子 GUI）', link: '/界面配置' },
      { text: 'AX 界面对接', link: '/AX界面对接' }
    ]
  },
  {
    text: '参考',
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: buildSidebar(manualSidebar),
    outline: { level: [2, 3], label: '大纲' },
    socialLinks: [
      { icon: 'github', link: 'https://github.com/2689508458/XiuXianCore-Wiki' }
    ],
